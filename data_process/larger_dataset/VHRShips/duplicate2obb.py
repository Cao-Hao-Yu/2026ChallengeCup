...
if __name__ == "__main__":
    # 输入路径（上一步处理好的HBB标签路径）
    input_path = r"D:\DeepLearning\Challenger\data\LargerDataset\VHRShips\hbblabels"
    
    # 输出路径（新的OBB标签路径）
    output_path = r"D:\DeepLearning\Challenger\data\LargerDataset\VHRShips\obblabels"
